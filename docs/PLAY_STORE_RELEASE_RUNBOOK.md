...
The project currently targets API level 35. New Google Play app submissions remain eligible at API 35 until August 31, 2026. Starting August 31, 2026, new apps and updates must target Android 16/API level 36 or higher, subject to Google Play’s published exceptions and extension process.

Plan and test the API 36 migration before the deadline rather than changing only the number immediately before submission.
