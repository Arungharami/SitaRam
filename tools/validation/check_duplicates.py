...
def check_duplicates(records_dir):
    ...
    if duplicates:
        ...
        print("No duplicates found. All Sargas are uniquely numbered.")
        return True

def main():
    parser = argparse.ArgumentParser(description="Check for duplicate document IDs or Sarga numbering in records.")
